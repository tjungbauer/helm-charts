...
| gitopsinstances.gitops_application.controller | object | `{"cpu_limits":"2","cpu_requests":"250m","env":[],"memory_limits":"2Gi","memory_requests":"1Gi","sharding":{"clustersPerShard":"","dynamicScalingEnabled":false,"enabled":false,"maxShards":"","minShards":"","replicas":""}}` | Settings for the Controller (Applications) This can set limits and requests |
