...
| tempostack.additionalAnnotations | object | {} | Additional annotations for chart-managed resources (merged with Argo CD sync metadata via tpl.argocdMetadata). |
...
| tempostack.namespace.additionalAnnotations | object | {} | Additional annotations for the namespace (merged with Argo CD sync metadata via tpl.argocdMetadata). |
...
| tempostack.syncwave | int | 10 | Sync wave for the TempoStack. |
