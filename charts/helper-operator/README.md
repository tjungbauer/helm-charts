...
| operators.my-operator.subscription.config.trustedCA | object | `{"configMap":"trusted-ca-bundle","configMapKey":"ca-bundle.crt","configMapPath":"ca-bundle.crt","enabled":false}` | Optionally set trusted CA bundle for the Operator. |
| operators.my-operator.subscription.config.trustedCA.configMap | string | "trusted-ca-bundle" | Name of the ConfigMap containing the CA bundle. |
| operators.my-operator.subscription.config.trustedCA.configMapKey | string | "ca-bundle.crt" | Key of the CA bundle in the ConfigMap. |
| operators.my-operator.subscription.config.trustedCA.configMapPath | string | "ca-bundle.crt" | Path of the CA bundle in the ConfigMap. |
| operators.my-operator.subscription.config.trustedCA.enabled | bool | false | Enable or disable the trusted CA bundle for the Operator. |
