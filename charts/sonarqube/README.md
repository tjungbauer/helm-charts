...
| sonarqube.route | object | `{"enabled":true,"host":"sonarqube.apps.ocp.aws.ispworld.at","tls":{"termination":"edge"}}` | Enable ingress, using the defind endpoint. |
